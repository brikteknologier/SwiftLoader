Pod::Spec.new do |s|
  ...
  s.screenshots      = "https://raw.githubusercontent.com/brikteknologier/SwiftLoader/master/images/loadergif.gif"
  s.license          = 'MIT'
  s.author           = { "Kirill Kunst" => "kirillkunst@gmail.com" }
  s.source           = { :git => "https://github.com/brikteknologier/SwiftLoader.git", :tag => s.version.to_s }
